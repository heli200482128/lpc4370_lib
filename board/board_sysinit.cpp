...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	/* Board LEDs 0 */
	{0x9, 3, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC0)},
	/* Board LEDs 1 */
	{0x9, 4, (SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC4)},
};
...
void Board_SetupClocking(void)
{
	...
	Chip_Clock_SetDivider(CLK_IDIV_C, CLKIN_MAINPLL, 6);
#endif /* defined(CORE_M4) */
}

...
{
	/* Set ports LED0 as outputs with initial states off */
	Chip_GPIO_SetPinDIR(LPC_GPIO_PORT, LED0_PORT, LED0_PIN, true);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, LED0_PORT, LED0_PIN, false);
	/* Set ports LED1 as outputs with initial states off */
	Chip_GPIO_SetPinDIR(LPC_GPIO_PORT, LED1_PORT, LED1_PIN, true);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, LED1_PORT, LED1_PIN, false);
}
...
void Board_LED_Set(uint8_t LEDNumber, bool On)
{
	...
	{
		Chip_GPIO_SetPinState(LPC_GPIO_PORT, LED1_PORT, LED1_PIN, On);
	}
}
...
bool Board_LED_Test(uint8_t LEDNumber)
{
	...
	{
		On = (bool) Chip_GPIO_GetPinState(LPC_GPIO_PORT, LED1_PORT, LED1_PIN);
	}
	return On;
}
